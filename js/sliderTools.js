...
Slider03.prototype.createUI = function () {
    ...
    //ul li 
    htmlStr ='<ul style="position:absolute;list-style:none;height:12px;border-radius:12px;padding:6px;padding-left:20px;right:125px;bottom:10px;background-color:#b2b2b2;opacity:0.8;">';
    for (let i = 0; i < this.imgs.length; i++) {
